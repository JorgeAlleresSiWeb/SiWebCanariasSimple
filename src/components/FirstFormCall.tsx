    ...
    <div className="bg-white shadow-sm mt-8">
      <div className="max-w-7xl mx-auto px-4 rounded">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center">
          ...
          <div className="p-8 bg-gradient-to-br from-[#2b6cb0] to-[#4299e1] text-white rounded-3xl">
          ...
          <div className="p-8">
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-br from-[#2b6cb0] to-[#4299e1] text-white py-3 px-6 rounded-md hover:opacity-90 transition-all text-xl font-medium"
