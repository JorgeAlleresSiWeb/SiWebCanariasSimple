    ...
    <div className="w-full">
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Formulario */}
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 shadow-lg bg-gradient-to-br from-[#2b6cb0] to-[#4299e1]">
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-white text-[#2b6cb0] py-4 px-6 rounded-lg hover:bg-white/90 transition-all font-bold text-lg"
