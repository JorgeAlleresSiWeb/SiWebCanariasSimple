      ...
      <div className="mx-auto p-8 shadow-sm pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-lg">
            <h3 className="text-xl font-semibold text-blue-600 mb-3">Sin IVA</h3>
            <p className="text-gray-700">
              Todo lo que recibes es completamente gratuito, ya que el IVA está exento para tu empresa.
            </p>
          </div>

          {/* Beneficio 2 */}
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-lg">
            <h3 className="text-xl font-semibold text-blue-600 mb-3">Servicios incluidos</h3>
            <p className="text-gray-700">
          ...
          {/* Beneficio 3 */}
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-lg">
            <h3 className="text-xl font-semibold text-blue-600 mb-3">Ayuda directa</h3>
            <p className="text-gray-700">
              Asesoramiento personalizado para aprovechar al máximo la subvención.
            </p>
          </div>
        </div>
      </div>
