    ...
    <section id="contact-form" className="py-16">
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-10 shadow-lg bg-gradient-to-br from-[#2b6cb0] to-[#4299e1] w-full max-w-4xl">
            <form className="space-y-6 sm:space-y-8">
              ...
              <button
                ...
                className="w-full bg-white text-[#0093E9] py-3 sm:py-4 mt-4 px-6 rounded-lg hover:bg-white/90 transition-all font-bold text-lg sm:text-xl"
              >
                Enviar
              </button>
            </form>
